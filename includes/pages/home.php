                ...
                <div class="tecnologias-bg">
                    <div class="container">
                        ...
                        <div class="bloco-jquery bloco-tecnlogias">
                            <img src="img/tecnologias/jquery.png" alt="jquery">
                        </div><!----/jquery-->
                        <div class="bloco-js bloco-tecnlogias">
                            <img src="img/tecnologias/js.png" alt="vanilla javascript ">
                        </div><!--js-->
                        <div class="bloco-wordpress bloco-tecnlogias">
                            <img src="img/tecnologias/wp.png" alt="wordpress">
                        </div><!--/wordpress-->

                        <!-- segunda linha -->

                        <div class="bloco-sass bloco-tecnlogias">
                            <img src="img/tecnologias/sass.png" alt="sass">
                        </div><!----/sass-->
                        <div class="bloco-git bloco-tecnlogias">
                            <img src="img/tecnologias/git.png" alt="git">
                        </div><!--git-->
                        <div class="bloco-angular bloco-tecnlogias">
                            <img src="img/tecnologias/angular.png" alt="angular">
                        </div><!--/angular-->
            ...
            <section class="sobre">
                <div class="container">
                    ...
                    <section class="sectionEsquerda">
                        <header>
                            <img src="img/perfil.png" alt="foto de perfil de matheus justo">
                            <h3>Matheus Justo</h3>
                        </header>
                        <article class="texto">
                            <p>
